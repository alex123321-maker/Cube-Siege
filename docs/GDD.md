...
- **3 макро-сектора биомов**:
  ...
  - **Равнина (Plains)**: Перепад высот 0..+4 блока. Открытые просторы, локальные неровности, декоративная трава, редкие деревья и валуны.
  ...
  - **Плавные границы**: Границы секторов искривлены процедурным шумом (Warping) для устранения прямых радиальных линий.
...
- **Свободные пикапы (1-3 ед.)**: Ветви, галька, самородки и кристаллы. Размещены на слое сенсора (слой 4), не блокируют движение, собираются мгновенно по [E] без боя.
