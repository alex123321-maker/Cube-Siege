...
- **Перспектива**: Изометрическая проекция под строго фиксированным углом (поворот ~45°, наклон ~35°, FOV 45°). Rotation и FOV камеры неизменны во время игрового процесса и не зависят от движения курсора, персонажа или выбранного пресета.
