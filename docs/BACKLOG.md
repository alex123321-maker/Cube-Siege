...
### Milestone 6: Стабилизация и Вертикальный Срез (Issue #20)
> *Подробный план и технические решения: [`docs/AUDIT_VERTICAL_SLICE_STABILIZATION.md`](AUDIT_VERTICAL_SLICE_STABILIZATION.md)*
- [ ] **Task 6.1 (P0)**: Возврат к Screen-Relative / Isometric WASD с сохранением контракта forced_target и Duel override Воина, независимый прицел мыши.
- [ ] **Task 6.2 (P0)**: Исправление подбора срубленных ресурсов (устранение бага `body_exited` при отключении коллизии / согласование формата лута).
- [ ] **Task 6.3 (P0)**: Исправление условия спуска стрел в `TerrainCombatRules` при стрельбе со склона вниз в рамках дискретного контракта Issue #18.
- [ ] **Task 6.4 (P1)**: Инструментальное профилирование стриминга чанков и террасирование гор по согласуемому GDD профилю.
- [ ] **Task 6.5 (P1)**: Блочная геометрия скал (тайлинг UV без растяжения) и юбка дна для исключения сквозных дыр.
- [ ] **Task 6.6 (P1)**: Устранение микро-строба камеры (синхронизация с физикой) и оптимизация рендера.
- [ ] **Task 6.7 (P1)**: Внедрение базового SFX-пакета и визуального боевого импакта (hit-flash / micro-knockback; screen-shake и сопутствующий тюнинг импакта требуют DESIGN DECISION REQUIRED per §2.9).
- [ ] **Task 6.8 (P2)**: Базовая навигация врагов (обход препятствий, расталкивание толпы/separation) и плавный step-up.
