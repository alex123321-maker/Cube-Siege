...
- [ ] **Task 6.2 (P0)**: Замена сломанного сбора срубленных ресурсов [E] на физические/магнитные лут-дропы.
- [ ] **Task 6.3 (P0)**: Исправление вертикального боя и баллистики стрел с высоты по целям внизу.
- [ ] **Task 6.4 (P1)**: Террасирование рельефа гор (плато и уступы вместо зебра-лестниц) и кластеризация ресурсов.
- [ ] **Task 6.5 (P1)**: Блочная геометрия скал (тайлинг UV без растяжения) и юбка дна для исключения сквозных дыр.
- [ ] **Task 6.6 (P1)**: Устранение микро-строба камеры (синхронизация с физикой) и оптимизация рендера (Mobile/Compatibility).
- [ ] **Task 6.7 (P1)**: Внедрение базового SFX-пакета (12 звуков) и визуального боевого импакта (hit-flash, screen shake).
