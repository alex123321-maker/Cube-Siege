...
| **GUT Testing Suite** | `addons/gut/`<br>`.gutconfig.json`<br>`tests/` | 49+ автоматических тестов (smoke, unit, integration), полное покрытие безопасных зон, кошелька, персистентности, 8 подсистем игрока, таранщика, директора волн, нативного пробника и типизированных сценариев взаимодействия. |
