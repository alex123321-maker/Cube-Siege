...
| **Лучник (Archer)** | ДПС на дистанции | Композитный лук | Пробивающая стрела (ПКМ) + Приманка-чучело (Q) | **Орлиный глаз**: отдаление камеры для стратегического обзора арены |
...
| **Особая атака** | `ПКМ` |
| **Рывок / Уворот** | `Пробел` |
| **Классовый навык (Парирование / Приманка / Турель)** | `Q` |
